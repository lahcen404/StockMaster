    ...
    <form id="taskForm" method="post" action="insert" class="mb-6">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
        <div>
          ...
          <input type="text" id="taskTitle" name="nom"
          ...
          <input type="text" id="taskTitle" name="quantity"
                 class="w-full border border-gray-300 rounded p-2 drop-shadow-md "
          ...
          <input type="text" id="taskTitle" name="prixUnite"
                 class="w-full border border-gray-300 rounded p-2 drop-shadow-md "
        ...
        <div>
          ...
          <select id="taskPriority" name="category" class="w-full border border-gray-300 rounded p-2 drop-shadow-md">
      ...
      <div class="mt-4">
        ...
        <textarea id="taskDescription" rows="3" name="description"
                  class="w-full border border-gray-300 rounded p-2 drop-shadow-md"
